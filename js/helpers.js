...
module.exports = {
  getBaseEnv: cleanEnv(process.env, {
    ...
    INFLUXDB_TOKEN: str({ default: "", desc: "InfluxDB API token." }),
    INFLUXDB_ORG: str({ default: "", desc: "InfluxDB organization id." }),
    INFLUXDB_BUCKET: str({ default: "", desc: "InfluxDB bucket to save data to." }),
    INFLUXDB_URL: str({ default: "", desc: "URL of InfluxDB. i.e. http://hostname:8086." }),
    SERVERS: str({
      default: null,
